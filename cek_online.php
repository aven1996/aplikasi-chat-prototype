...
<html>
    <head>
        <title>Cek Koneksi Internet dengan javaScript</title>
    ...
    <body>
        <div class="container">
            <br />
            <br />
            <h1 align="center">Toast Notification untuk check koneksi internet dengan JavaScript</h1>
            <br />          
        </div>
...
function check_internet_connection()
{
    ...
    if(current_status == status)
    {
        if(status == 'online')
        {
            ...
            $('.toast-body').text('  Hore, internet tersambung.');
        ...
        else
        {
            ...
            $('.toast-body').text('Opps! Internet terputus.');
            
        }

        current_status = status;

        // autohide toast notification => false
        $('.toast').toast({
            autohide:false
        });
